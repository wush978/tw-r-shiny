...
RUN \
    ...
    apt-get install -y --no-install-recommends git build-essential libcairo2-dev libtiff4-dev libreadline-dev gfortran wget default-jdk gdebi-core sudo vim fonts-arphic-ukai r-base 
# && \ 
